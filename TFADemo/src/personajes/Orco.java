 ...
 */
public class Orco extends Personaje implements Collidable{
    private float distancia;
    private int estado;
    private GestorColisiones gestor;
    private SpriteSheet enem;
    
    public Orco(GameContainer container, Collidable colisiones, GestorColisiones gestor) throws SlickException{
        super(container);
        this.enem = new SpriteSheet("testdata/spritesPJ/orco.png",64,64);
