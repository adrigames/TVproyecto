 ...
 */
public class Enemigo extends Personaje implements Collidable{
    ...
    public Enemigo(GameContainer container, Collidable colisiones, GestorColisiones gestor) throws SlickException{
        super(container);
        this.enem = new SpriteSheet("testdata/spritesPJ/esqueleto.png",64,64);
    ...
    public void alColisionar(Collidable colision) {
        if(colision.getClass().getSimpleName().equals("personajes.Heroe")){
            heroe = (Heroe) colision;
