 ...
 */
public class Rey extends Personaje implements Collidable{
    ...
    public Rey(GameContainer container, Collidable colisiones, GestorColisiones gestor) throws SlickException{
        super(container);
        this.enem = new SpriteSheet("testdata/spritesPJ/rey.png",64,64);
